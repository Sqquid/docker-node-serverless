...
This image is based on node:10.19-alpine ([AWS Lambda uses Node v10.x](http://docs.aws.amazon.com/lambda/latest/dg/current-supported-versions.html)) and has the AWS CLI, Serverless and Yarn installed.
